...
(defmacro defun-tagary (function-name args doc &rest body) ;§tood:rename ot:defun-tags
  "Macro to create interactive commands where \\[universal-argument]s would enable switch between primary and secondary tag"
